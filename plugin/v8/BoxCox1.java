...
public class BoxCox1 extends ModalSplitMethod {
   ...
   */
  public BoxCox1(NodusProject nodusProject) {
    super(nodusProject);
  }
  ...
  private PathsForMode computeUtility(PathsForMode modalPaths) {
    ...
    modalPaths.utility = paramValue[mode][0] + paramValue[mode][1] * cost;
    return modalPaths;
  }
   ...
   * @param pathsList The list that contains the routes over which the volume must be spread.
